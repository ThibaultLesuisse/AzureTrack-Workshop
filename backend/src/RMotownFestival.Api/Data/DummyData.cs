    ...
    static class FestivalDataSource
    {
        ...
        static FestivalDataSource()
        {
            ...
            var stages = new List<Stage>() {
                         ...
                         new Stage { Id = 3, Name = "PinkRoom", Description = description }
            };
            ...
            lineUp.Items.Add(new ScheduleItem { Id = 2, Artist = artists[4], Stage = stages[5], Time = new DateTime(1972, 07, 01, 20, 30, 0) });
